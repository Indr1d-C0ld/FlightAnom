    ...
    <table class="cards">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td data-label="Reg"><?php $rg = $ev['reg'] ?? ''; if ($rg !== ''): ?><a href="index.php?reg=<?= urlencode($rg) ?>&amp;quick_range=all" title="Tutti gli eventi di <?= htmlspecialchars($rg) ?> (sempre)"><?= htmlspecialchars($rg) ?></a> <button class="copy-btn" onclick="copyText(this.dataset.copy)" data-copy="<?= htmlspecialchars($rg) ?>" title="Copia Reg">📋</button><?php endif; ?></td>
